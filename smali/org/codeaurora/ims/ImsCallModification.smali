...
.method private isOldAndNewPauseRequestSame()Z
    ...
    const-string v3, "isOldAndNewPauseRequestSame Unexpectedly callModifyRequest:"
    ...
    :cond_0
    iget-boolean v2, p0, Lorg/codeaurora/ims/ImsCallModification;->mIsLocallyPaused:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Lorg/codeaurora/ims/ImsCallModification;->mPendingVTMultitask:Lorg/codeaurora/ims/ImsCallModification$PauseState;

    sget-object v3, Lorg/codeaurora/ims/ImsCallModification$PauseState;->PAUSE:Lorg/codeaurora/ims/ImsCallModification$PauseState;
    ...
    sget-object v3, Lorg/codeaurora/ims/ImsCallModification$PauseState;->RESUME:Lorg/codeaurora/ims/ImsCallModification$PauseState;
...
.method private modifyCallInitiate(Landroid/os/Message;ILjava/util/Map;)V
    ...
    const-string v3, "modifyCallInitiate not a Valid RilCallType"
...
.method private retryAvpUpgrade(Z)V
    ...
    const-string v2, "retryAvpUpgrade: AVPF failed so retrying using AVP. mAvpCallType="
    ...
    const-string v2, " shouldNotifyUser="
...
.method private triggerOrQueueVTMultitask(I)V
    ...
    const-string v2, "triggerOrQueueVTMultitask callType= "
...
.method private validateCanModifyConnectionType(Landroid/os/Message;I)Z
    ...
    const-string v10, "validateCanModifyConnectionType newCallType="
    ...
    invoke-direct {p0, v9}, Lorg/codeaurora/ims/ImsCallModification;->log(Ljava/lang/String;)V

    .line 128
    iget-object v9, p0, Lorg/codeaurora/ims/ImsCallModification;->mImsCallSessionImpl:Lorg/codeaurora/ims/ImsCallSessionImpl;

    invoke-virtual {v9}, Lorg/codeaurora/ims/ImsCallSessionImpl;->getInternalCallType()I
    ...
    const-string v7, "validateCanModifyConnectionType currCallType= "
    ...
    const-string v7, " modifyToCurrCallType="
...
.method public acceptConnectionTypeChange(ILjava/util/Map;)V
    ...
    const-string v3, "Confirming call type change request: "
    ...
    const-string v2, "acceptConnectionTypeChange: MODIFY_CALL_CONFIRM called with invalid calltype "
...
.method public changeConnectionType(Landroid/os/Message;ILjava/util/Map;)V
    ...
    const-string v4, "changeConnectionType  newCallType="
    ...
    .line 358
    :cond_3
    const-string v3, "VideoCall_ImsCallModification"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "videocall changeConnectionType: not invoking modifyCallInitiate as there is pending callModifyRequest="
...
.method public onReceivedModifyCall(Lorg/codeaurora/ims/CallModify;)V
    ...
    const-string v3, "onReceivedCallModify("
    ...
    invoke-direct {p0, v1, v2}, Lorg/codeaurora/ims/ImsCallModification;->validateCanModifyConnectionType(Landroid/os/Message;I)Z
...
.method public rejectConnectionTypeChange()V
    ...
    const-string v4, "rejectConnectionTypeChange callModifyRequest is null"
    ...
    const-string v4, "rejectConnectionTypeChange callModifyRequest timed out."
    ...
    const-string v5, "Rejecting Change request: "
...
.method public update(Lorg/codeaurora/ims/DriverCallIms;)V
    ...
    .line 267
    const-string v4, "videocall: update: Not a videocall CASE"
    ...
    const-string v6, "videocall AVP RETRY CASE dc= "
