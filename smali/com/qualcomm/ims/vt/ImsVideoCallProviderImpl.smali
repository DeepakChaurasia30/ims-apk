...
.method private handleSessionModifyDone(Landroid/os/Message;)V
    ...
    const-string v4, "handleSessionModifyDone msg.what="
    ...
    .line 166
    const-string v3, "Session modify success"
    ...
    .line 170
    const-string v3, "Session modify error"
    ...
    invoke-static {v3}, Lorg/codeaurora/ims/ImsCallUtils;->getUiErrorCode(I)I
    ...
    :cond_2
    const-string v3, "handleSessionModifyDone:null message object"
...
.method private isVideoPauseRequested(Landroid/telecom/VideoProfile;)Z
    ...
    invoke-static {v0}, Landroid/telecom/VideoProfile$VideoState;->isPaused(I)Z
...
.method public onCallDataUsageChanged(J)V
    ...
    invoke-virtual {p0, v0}, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->changeCallDataUsage(I)V
...
.method public onRequestCallDataUsage()V
    ...
    .prologue
    .line 251
    const-string v1, "onRequestCallDataUsage"
...
.method public onRequestCameraCapabilities()V
    ...
    invoke-virtual {v1}, Lcom/qualcomm/ims/vt/CameraController;->getCameraCapabilities()Landroid/telecom/CameraCapabilities;

    move-result-object v0

    .line 211
    .local v0, "cc":Landroid/telecom/CameraCapabilities;
    if-eqz v0, :cond_1

    .line 212
    invoke-virtual {p0, v0}, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->changeCameraCapabilities(Landroid/telecom/CameraCapabilities;)V
...
.method public onSendSessionModifyRequest(Landroid/telecom/VideoProfile;)V
    ...
    const-string v3, "onSendSessionModifyRequest, videoState="
    ...
    .line 138
    iput-object p1, p0, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->mRequestProfile:Landroid/telecom/VideoProfile;
    ...
    .line 142
    :cond_0
    invoke-direct {p0, p1}, Lcom/qualcomm/ims/vt/ImsVideoCallProviderImpl;->isVideoPauseRequested(Landroid/telecom/VideoProfile;)Z
...
.method public onSendSessionModifyResponse(Landroid/telecom/VideoProfile;)V
    ...
    const-string v2, "onSendSessionModifyResponse, responseProfile state="
...
.method public onUnsolCallModify(Lorg/codeaurora/ims/ImsCallSessionImpl;Lorg/codeaurora/ims/CallModify;)V
    ...
    const-string v4, "onCallTypeChanged session="
...
.method public sendCameraStatus(Z)V
    ...
    .prologue
    .line 232
    const-string v1, "sendCameraFailure"
